...
function buildHtml(
  ...
  const rows: Array<[string, string]> = summary
    ? [
        ...
        ['Cégméret', summary.cegmeret],
        ['Volumen', summary.volumen],
        ['Jelenlegi megoldás', summary.jelenlegi_megoldas],
        ['Időzítés', summary.idozites],
        ['Döntési kör', summary.dontesi_kor],
        ['Fizetőképesség (becslés)', summary.koltsegvetes_jel],
