...
const es = {
  seo: SEO,
  nav: {
    links: [["Agentes", "agentek"], ["Proceso", "folyamat"], ["Sitios web", "weboldal", "/weboldal"], ["Caso práctico", "eset"]],
    contact: "CONTACTO",
  ...
  hero: {
    ...
    callback: {
      title: "O te llamamos nosotros, ahora mismo",
      lead: "Escribe tu número y el agente te llama en 10 segundos. Es gratis y puedes colgar cuando quieras.",
      placeholder: "+34 612 345 678",
      cta: "Llámame",
      sending: "Marcando…",
      ok: "Listo — el agente está llamando. Tu teléfono sonará en 10 segundos.",
      errNumber: "No reconozco ese número. Prueba así: +34 612 345 678",
      errCountry: "No podemos llamar a ese prefijo de país, lo sentimos.",
      errRepeat: "Ya hemos llamado a ese número hoy. Inténtalo mañana.",
      errDaily: "La cuota de hoy se ha agotado. Inténtalo mañana o escríbenos.",
    ...
    stats: [["2–4 semanas", "el primer agente"], ["3 idiomas", "habla el agente telefónico"], ["100%", "aprobación humana"]],
  },
  agentsSection: {
    ...
    approved: "Aprobado — sale.",
    rewritten: "Devuelto para reescribir.",
    again: "↻ Otra vez",
    sampleNote: "Una ilustración con datos de ejemplo en húngaro — los correos son inventados.",
  },
  agents: [
  ...
  notFound: {
    ...
    lead: "Puede que la dirección esté mal escrita, o que la página ya no exista.",
    home: "← Volver a la página principal",
    agents: "Ver los agentes",
  },
  caseStudy: {
    tag: "En acción",
