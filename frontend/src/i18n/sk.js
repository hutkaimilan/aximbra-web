...
const CALLBAR = mailto("Koľko hovorov zmeškávame?");
...
const sk = {
  ...
  agentsSection: {
    ...
    approved: "Schválené — ide von.",
    rewritten: "Vrátené na prepísanie.",
    again: "↻ Znova",
    sampleNote: "Ilustrácia s maďarskými vzorovými údajmi — e-maily sú vymyslené.",
  },
  agents: [
