  ...
  hu: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Semmit nem tárolunk.", d: "A futás 30 perc után magától lejár, a lap bezárásával pedig azonnal törlődik." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "A „Kilépés” azonnal törli a futást és a hozzáférést. A lap bezárása ugyanezt teszi.",
  ...
  en: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "We store nothing.", d: "The run expires by itself after 30 minutes, and closing the page deletes it immediately." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "\"Log out\" deletes the run and the access immediately. Closing the page does the same.",
  ...
  de: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Wir speichern nichts.", d: "Der Lauf verfällt nach 30 Minuten von selbst, und mit dem Schließen der Seite wird er sofort gelöscht." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "„Abmelden\" löscht Lauf und Zugriff sofort. Das Schließen der Seite bewirkt dasselbe.",
  ...
  es: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "No almacenamos nada.", d: "La ejecución caduca sola a los 30 minutos, y al cerrar la página se borra al instante." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "«Salir» borra la ejecución y el acceso al instante. Cerrar la página hace lo mismo.",
  ...
  fr: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Nous ne stockons rien.", d: "L'exécution expire d'elle-même au bout de 30 minutes, et se supprime immédiatement à la fermeture de la page." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "« Se déconnecter » supprime immédiatement l'exécution et l'accès. Fermer la page fait de même.",
  ...
  it: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Non conserviamo nulla.", d: "L'esecuzione scade da sola dopo 30 minuti, e chiudendo la pagina viene cancellata subito." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "«Esci» cancella subito l'esecuzione e l'accesso. Chiudere la pagina fa lo stesso.",
  ...
  ro: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Nu stocăm nimic.", d: "Rularea expiră singură după 30 de minute, iar la închiderea paginii se șterge imediat." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "„Ieșire\" șterge imediat rularea și accesul. Închiderea paginii face același lucru.",
  ...
  sk: {
    ...
    intro: {
      ...
      guarantees: [
        ...
        { t: "Nič neukladáme.", d: "Beh sám vyprší po 30 minútach a zatvorením stránky sa okamžite zmaže." },
      ],
    },
    disclosure: {
      ...
      lifeExit: "„Odhlásenie\" okamžite zmaže beh aj prístup. Zatvorenie stránky urobí to isté.",
