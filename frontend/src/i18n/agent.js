...
const agent = {
  ...
  zh: {
    seo: {
      title: "邮件分拣代理 — 在线演示 | AXIMBRA",
      description:
        "在线演示：代理会查看您邮箱最近 30 天的邮件，按紧急程度排序并撰写回复。" +
        "默认只读——它无法发送邮件。",
    },
    title: "邮件分拣代理",
    notConnected: "未连接",
    err: {
      access_denied: "您拒绝了 Google 授权，或流程被中断。",
      invalid_state: "流程已过期，请重新开始连接。",
      token_exchange: "与 Google 的交换失败，请再试一次。",
      no_email: "Google 没有返回该账号的邮箱地址。",
      busy: "同时尝试的人太多了，请几分钟后再来。",
      generic: "错误",
      unknown: "未知错误。",
      search_too_short: "请至少输入两个字符。",
      search_limit: "本次会话的搜索次数已用完。",
      search_failed: "搜索失败，请再试一次。",
    },
    urgency: { u5: "立即", u4: "紧急", u3: "一般", u1: "可以等" },
    cat: {
      customer_question: "客户 – 咨询",
      customer_complaint: "客户 – 投诉",
      opportunity: "商业机会",
      invoice: "发票 / 财务",
      authority: "政府 / 官方",
      provider_notice: "服务商通知",
      newsletter: "电子报 / 营销",
      spam: "垃圾邮件 / 未经请求",
      other: "其他",
    },
    search: {
      ...
      results1: "“{q}”共 1 条结果",
      none: "没有找到“{q}”的结果",
      note: "搜索范围是整个邮箱，而不只是分析过的 30 天。搜索结果不会分类——那需要每封邮件调用一次模型。",
      openInGmail: "在 Gmail 中打开 →",
    },
    tone: { group: "语气", hivatalos: "正式", kozvetlen: "直接" },
    draft: {
      write: "撰写回复",
      rewrite: "重写",
      writing: "撰写中…",
      ...
      copy: "复制",
      copied: "已复制",
      clipboardError: "剪贴板不可用——请选中文字手动复制。",
      save: "保存到 Gmail 草稿",
      send: "发送邮件",
      noteWrite: "发送前我们会再确认一次——只有您能发送。",
      noteRead: "这是一份草稿——代理不会发送它，也不会写入您的账号。",
      saveText: "我将在您的 Gmail 账号中写一份回复 {sender} 的草稿，放在原邮件的会话里。",
      saveNotSend: "我不会发送它",
      saveNotSendRest: "——您会在草稿箱中找到它，由您决定是否发出。",
      saveYes: "确认，保存为草稿",
      saving: "保存中…",
      cancel: "取消",
      sendTitle: "这将真的立即发送这封邮件。",
      to: "收件人",
      from: "发件人",
      fromValue: "您的 Gmail 账号",
      sendWarn:
        "此操作无法撤销。请阅读上方文字——方括号中的部分（[像这样]）" +
        "需要您在发送前自行填写。",
      sendYes: "是的，立即发送",
      sending: "发送中…",
      sent: "已发送。",
      savedNew: "草稿已保存。",
      savedUpdated: "草稿已更新。",
      openGmail: "在 Gmail 中打开",
    },
    intro: {
      lead:
        "连接您的 Gmail 账号后，代理会查看最近 30 天的邮件：按类别分类、判断紧急程度，" +
        "并告诉您哪些邮件需要回复。对于您选中的邮件，它还会撰写回复。",
      guarantees: [
        { t: "默认只读。", d: "如果不勾选下方的选项，它不会在您的账号中写入任何内容，也不会申请发送权限。" },
        { t: "只有您点击时，它才会动您现有的邮件。", d: "单独勾选后，您可以一键把电子报和垃圾邮件移到回收站——仅此而已，并且始终由您点击。Gmail 回收站中的邮件约 30 天内可以恢复；不会永久删除任何内容。" },
        { t: "撰写和发送只在您允许时进行。", d: "即使勾选了选项，在写草稿或发送任何内容之前，我们也会针对每封邮件单独确认。" },
        { t: "我们不存储任何内容。", d: "分析会在 30 分钟后自动过期。关闭页面会通知服务器并立即删除——如果通知没有送达，30 分钟的时限也会结束它。" },
      ],
    },
    product: {
      title: "这是一个演示——以及您可以购买的东西",
      demoLead: "本页面上的任何内容都不会保留。",
      demoText: "分析 30 分钟后自动过期，关闭页面即删除，每次连接都从零开始。这是演示的刻意限制，而不是系统的限制。",
      yoursLead: "您订购的是属于您自己的系统：",
      yoursText: "一个只有您能访问的应用或网站——您的账号，您的服务器。",
      points: [
        "不会自动断开连接。连接会一直保持，直到您自己结束。",
        "代理每两小时自动查看一次新收到的邮件，如果有需要回复的就告诉您。",
        "首次连接时，它会回溯过去五个月，标出可能还没处理完的邮件——排序方式与您在这里看到的相同。",
        "也可以搜索：任何关键词都能从整个邮箱中找出相关邮件。",
      ],
      cta: "问问在您的邮箱上会是什么样子",
    },
    disclosure: {
      summary: "我们具体申请什么权限，您的数据会怎样？",
      scopesTitle: "申请的 Google 权限",
      scopeRead: "读取您的邮件。这是始终需要的，默认情况下也是我们申请的唯一权限。",
      scopeIdentity: "以便我们知道正在查看的是哪个账号。",
      scopeComposeLead: "仅当您勾选撰写草稿时。",
      scopeCompose: "有了这个权限，它才能在您的账号中放入草稿，并在您针对该邮件确认后发送这封回复。Google 没有“仅限草稿”的权限。它绝不会自行发送：只有在您单独确认后才会发送。如果不勾选，我们根本不会申请这个权限。",
      readTitle: "我们读取什么",
      read30: "最多读取最近 30 天内的 50 封邮件。不会更早，也不会更多。",
      readFields: "发件人、主题、日期和邮件正文。",
      readAttachLead: "只有当邮件正文本身内容太少时才读取附件",
      readAttach:
        "——例如“资料已发送，详见附件”这类邮件，实质内容在文件里。" +
        "这种情况下，我们每封邮件最多从两个文件中提取文字（Word、Excel、PowerPoint、PDF、纯文本；" +
        "不包括图片或视频）。文件本身不会被保存，只有提取出的文字会交给分类程序。",
      writeTitle: "我们写入什么",
      writeNoneLead: "不勾选时：",
      writeNone: "什么都不写。草稿留在页面上，由您复制出来。",
      writeDraft: "勾选撰写草稿后，针对每封邮件、并且始终在您单独确认之后：在 Gmail 草稿箱中写入回复草稿，以及——如果您也确认了——发送这份草稿。我们不会修改现有邮件：不加标签、不加星标、不删除。",
      whereTitle: "数据去向",
      whereLlm:
        "邮件文字会通过一次分类调用发送到 OpenAI 的 API。默认情况下，" +
        "服务商不会将通过 API 提交的数据用于模型训练。",
      whereNoDb: "不写入任何数据库。分析结果只存在于服务器内存中。",
      lifeTitle: "保留多久，以及如何删除",
      life30: "会话在 30 分钟后自动过期。",
      lifeExit: "“退出”会立即删除分析结果和访问权限。浏览器的通知送达时，关闭页面也会产生同样效果；否则由 30 分钟时限结束。",
      lifeRevoke: "您可以随时在 Google 撤销该权限：",
      whoTitle: "谁在申请",
      whoText: "——有任何问题或删除请求，请写信给我们，我们会回复。",
    },
    closed: {
      title: "该代理尚未公开。",
      body:
        "在向任何人申请 Gmail 访问权限之前，我们会先公布隐私声明和公司信息——" +
        "在此之前，我们不会向任何人申请邮箱访问权限。",
      live: "我们很乐意用自己的账号为您现场演示：",
      liveSubject: "我想看看邮件代理的现场演示",
    },
    start: {
      cta: "在示例邮箱上查看",
      starting: "启动中…",
      ...
      empty: "最近 30 天没有需要处理的邮件。",
      interrupted: "分析已中断，请再试一次。",
      budget: "代理今天的预算已用完。",
      noSubject: "（无主题）",
      note:
        "10 封真实风格的匈牙利语邮件，立即可看，无需登录。在它们上面运行的代理" +
        "与在真实邮箱上运行的完全相同——也会撰写回复。",
      alt: "我更想在自己的 Gmail 账号上试试 →",
    },
    connect: {
      notConfigured: "代理的 Google 访问尚未配置。",
      googleTitle: "Google 会向您显示什么。",
      googleBody:
        "在放行之前，会出现一个红色的“Google 尚未验证此应用”页面。" +
        "所有申请邮箱访问、但尚未通过 Google 安全评估的应用都会出现这个页面——" +
        "它与您账号的状况无关。",
      googleHow:
        "您可以通过“高级”→“转至…”继续。如果现在觉得不放心，" +
        "示例邮箱无需登录即可展示全部功能。",
      back: "← 返回示例邮箱",
      warn: {
        title: "在跳转之前：Google 会显示一个警告",
        why: "在下一个页面，Google 会显示“Google 尚未验证此应用”。这是因为 AXIMBRA 还没有完成 Google 要求所有读取邮件的应用每年进行的付费安全审计。作为一人工作室，我们会在接到首批客户项目后进行这项审计。",
        means: "这表示 Google 还没有审查这个应用——并不表示您的账号有问题，也不表示 Google 发现了问题。",
        checkTitle: "您可以自己核实的事：",
        checks: ["Google 的授权页面会准确列出我们申请的访问权限。只读以外的权限，只有在您勾选了上方选项时才会申请。", "分析会在 30 分钟后自动删除；您的邮件不会写入数据库。"],
        revoke: "您可以随时在 Google 账号中撤销访问权限：",
        howTitle: "如何通过警告页面：",
        steps: ["点击底部的“高级”链接。", "点击“转至 aximbra.hu（不安全）”。", "选择您的账号并接受所申请的权限。"],
        go: "明白了，前往 Google",
        cancel: "取消",
      },
      optinTitle: "允许在我的邮箱中写入草稿。",
      optinBody:
        "勾选后，代理会把它写好的回复——在您针对每封邮件单独确认后——" +
        "放入 Gmail 草稿箱，并归入原邮件的会话。发送仍然只能由您来做。",
      optinWarn: "注意：Google 没有“仅限草稿”的权限，因此授权页面也会提到发送权限。代理绝不会自行发送邮件——只会发送您单独确认过的草稿——但您授予的权限比这更广。如果对此不放心，请不要勾选：不勾选也能撰写回复，只是需要您把文字复制出来。",
      cleanupTitle: "允许整理不重要的邮件。",
      cleanupBody:
        "勾选后，电子报和垃圾邮件可以一键移到回收站——" +
        "逐封或一次全部。它只涉及这两个类别，并且始终由您点击。",
      cleanupWarn: "Gmail 回收站中的邮件约 30 天内可以恢复，不会永久删除任何内容。Google 为此要求更广的权限，因为仅有读取权限无法移动邮件。",
      ctaClean: "连接——读取并整理",
      ctaRead: "连接 Google 账号",
      ctaWrite: "连接——读取并撰写草稿",
      redirecting: "正在跳转…",
      privacyLead: "AXIMBRA 对从 Google API 获取的信息的使用和传输，遵守 Google API Services User Data Policy，包括其中的 Limited Use（有限使用）要求。",
      privacyLink: "隐私声明",
    },
    run: {
      sampleNoteTitle: "示例邮箱。",
      sampleNote:
        "邮件是虚构的——但分类和回复是刚刚生成的，" +
        "由与真实账号上运行的完全相同的代理完成。",
      starting: "启动中…",
      ...
      mostUrgent: "最紧急",
      categories: "类别分布",
      filterNote: "只显示等待回复的邮件。",
      junkFilterNote: "只显示标记为不重要的邮件。",
      showAllN: "显示全部 {n} 封邮件",
      whyUrgent: "为何是这个紧急程度",
      nextStep: "建议的下一步",
      theEmail: "邮件内容",
      empty: "（空）",
      noEmails: "没有找到最近 30 天的邮件。",
      junkTitle: "不重要的邮件",
      junkTag: "不重要",
      junkNote: "电子报和垃圾邮件。它们会被移到回收站，Gmail 在约 30 天内可以恢复。",
      junkAll: "全部删除（{n}）",
      junkConfirm: "确定吗？{n} 封邮件将移到回收站。",
      junkYes: "是的，继续",
      junkNo: "取消",
      junkOne: "移到回收站",
      junkBusy: "删除中…",
      junkDone: "{n} 封邮件已移到回收站，约 30 天内可在 Gmail 中恢复。",
      junkNoGrant: "如需整理，请重新连接并勾选整理选项。",
      logout: "退出并断开连接",
      foot: "退出会立即断开您的账号，并从服务器删除分析结果。",
    },
    unreachable: {
      title: "代理暂时无法使用。",
      body: "无法连接到服务器——通常只是新版本启动时的几秒钟。",
      retry: "再试一次",
    },
  },
};
