...
const CALLBAR = mailto("Quante chiamate stiamo perdendo?");
...
const it = {
  ...
  hero: {
    phoneCta: { badge: "IA", note: "Risposto da un agente IA · in inglese e ungherese", origin: "Numero USA (Twilio) — le chiamate da numeri non ungheresi le prende l'agente IA" },
  ...
  agentsSection: {
    ...
    tryClose: "Chiudi",
    simOpen: "Guardalo in azione",
    skip: "Vai alla fine →",
    approve: "Approva",
    rewrite: "Chiedi una riscrittura",
    approved: "Approvato — parte.",
    rewritten: "Rimandato per la riscrittura.",
    again: "↻ Di nuovo",
    sampleNote: "Un'illustrazione con dati di esempio in ungherese — le e-mail sono inventate.",
  },
  agents: [
  ...
  contact: {
    phoneOrigin: "Numero USA (Twilio). Le chiamate da numeri non ungheresi le prende l'agente IA, in inglese.",
