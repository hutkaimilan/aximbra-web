...
const de = {
  seo: SEO,
  nav: {
    links: [["Agenten", "agentek"], ["Ablauf", "folyamat"], ["Website", "weboldal", "/weboldal"], ["Fallstudie", "eset"]],
    contact: "KONTAKT",
  ...
  agentsSection: {
    ...
    approved: "Freigegeben — geht raus.",
    rewritten: "Zur Überarbeitung zurückgeschickt.",
    again: "↻ Nochmal",
    sampleNote: "Eine Illustration mit ungarischen Beispieldaten — die Mails sind erfunden.",
  },
  agents: [
