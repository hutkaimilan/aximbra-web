...
const CALLBAR = mailto("Câte apeluri pierdem?");
...
const ro = {
  ...
  agentsSection: {
    ...
    approved: "Aprobat — pleacă.",
    rewritten: "Trimis înapoi pentru rescriere.",
    again: "↻ Din nou",
    sampleNote: "O ilustrație cu date de exemplu în maghiară — e-mailurile sunt inventate.",
  },
  agents: [
