...
- **Mobile demo cards**: whole card is a comfortable tap target (bigger padding + min-height 190px, `:active` press feedback, `-webkit-tap-highlight-color:transparent`), "Megnézem →" CTA rendered as a visible accent pill on ≤760px. Verified tapping card title (not CTA) navigates.
